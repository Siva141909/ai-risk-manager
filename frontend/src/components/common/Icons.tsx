/** Small, fixed icon set (docs/DESIGN_SYSTEM.md §6) — inline SVG, no
 * icon-font/network dependency, `currentColor` so each icon inherits
 * whatever token color its container sets. */
